...
// Ladder jumps Tailwind shades by ~150 steps per instance rather than 50.
// The previous 50→100 transition was visually indistinguishable on small
// grid cells (especially after JPEG compression in screenshots). 50→200
// is clearly different at a glance even at 10px font size.
const SHADE_LADDERS: Record<string, ShadePair[]> = {
  yellow:   [
    { fill: "bg-yellow-50",     ring: "border-yellow-500" },
    { fill: "bg-yellow-200",    ring: "border-yellow-600" },
    { fill: "bg-yellow-400",    ring: "border-yellow-700" },
    { fill: "bg-yellow-600",    ring: "border-yellow-800" },
  ],
  slate:    [
    { fill: "bg-slate-100",     ring: "border-slate-400" },
    { fill: "bg-slate-300",     ring: "border-slate-600" },
    { fill: "bg-slate-400",     ring: "border-slate-700" },
    { fill: "bg-slate-500",     ring: "border-slate-800" },
  ],
  emerald:  [
    { fill: "bg-emerald-50",    ring: "border-emerald-500" },
    { fill: "bg-emerald-200",   ring: "border-emerald-600" },
    { fill: "bg-emerald-400",   ring: "border-emerald-700" },
    { fill: "bg-emerald-600",   ring: "border-emerald-800" },
  ],
  sky:      [
    { fill: "bg-sky-50",        ring: "border-sky-500" },
    { fill: "bg-sky-200",       ring: "border-sky-600" },
    { fill: "bg-sky-400",       ring: "border-sky-700" },
    { fill: "bg-sky-600",       ring: "border-sky-800" },
  ],
  violet:   [
    { fill: "bg-violet-50",     ring: "border-violet-500" },
    { fill: "bg-violet-200",    ring: "border-violet-600" },
    { fill: "bg-violet-400",    ring: "border-violet-700" },
    { fill: "bg-violet-600",    ring: "border-violet-800" },
  ],
  indigo:   [
    { fill: "bg-indigo-50",     ring: "border-indigo-500" },
    { fill: "bg-indigo-200",    ring: "border-indigo-600" },
    { fill: "bg-indigo-400",    ring: "border-indigo-700" },
    { fill: "bg-indigo-600",    ring: "border-indigo-800" },
  ],
  amber:    [
    { fill: "bg-amber-50",      ring: "border-amber-500" },
    { fill: "bg-amber-200",     ring: "border-amber-600" },
    { fill: "bg-amber-400",     ring: "border-amber-700" },
    { fill: "bg-amber-600",     ring: "border-amber-800" },
  ],
  fuchsia:  [
    { fill: "bg-fuchsia-50",    ring: "border-fuchsia-500" },
    { fill: "bg-fuchsia-200",   ring: "border-fuchsia-600" },
    { fill: "bg-fuchsia-400",   ring: "border-fuchsia-700" },
    { fill: "bg-fuchsia-600",   ring: "border-fuchsia-800" },
  ],
  purple:   [
    { fill: "bg-purple-50",     ring: "border-purple-500" },
    { fill: "bg-purple-200",    ring: "border-purple-600" },
    { fill: "bg-purple-400",    ring: "border-purple-700" },
    { fill: "bg-purple-600",    ring: "border-purple-800" },
  ],
  blue:     [
    { fill: "bg-blue-50",       ring: "border-blue-500" },
    { fill: "bg-blue-200",      ring: "border-blue-600" },
    { fill: "bg-blue-400",      ring: "border-blue-700" },
    { fill: "bg-blue-600",      ring: "border-blue-800" },
  ],
  cyan:     [
    { fill: "bg-cyan-50",       ring: "border-cyan-500" },
    { fill: "bg-cyan-200",      ring: "border-cyan-600" },
    { fill: "bg-cyan-400",      ring: "border-cyan-700" },
    { fill: "bg-cyan-600",      ring: "border-cyan-800" },
  ],
  orange:   [
    { fill: "bg-orange-50",     ring: "border-orange-500" },
    { fill: "bg-orange-200",    ring: "border-orange-600" },
    { fill: "bg-orange-400",    ring: "border-orange-700" },
    { fill: "bg-orange-600",    ring: "border-orange-800" },
  ],
  pink:     [
    { fill: "bg-pink-50",       ring: "border-pink-500" },
    { fill: "bg-pink-200",      ring: "border-pink-600" },
    { fill: "bg-pink-400",      ring: "border-pink-700" },
    { fill: "bg-pink-600",      ring: "border-pink-800" },
  ],
  red:      [
    { fill: "bg-red-50",        ring: "border-red-500" },
    { fill: "bg-red-200",       ring: "border-red-600" },
    { fill: "bg-red-400",       ring: "border-red-700" },
    { fill: "bg-red-600",       ring: "border-red-800" },
  ],
  green:    [
    { fill: "bg-green-50",      ring: "border-green-500" },
    { fill: "bg-green-200",     ring: "border-green-600" },
    { fill: "bg-green-400",     ring: "border-green-700" },
    { fill: "bg-green-600",     ring: "border-green-800" },
  ],
};
