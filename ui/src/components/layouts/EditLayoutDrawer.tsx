    ...
    <>
      ...
      >
        <div className="flex items-start justify-between px-6 py-5">
          <div>
            <h2 className="text-xl font-semibold text-fg">Edit Layout</h2>
            <p className="mt-1 text-sm text-muted">Update name, monitors, and notes.</p>
          </div>
          <button
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5">
          <label className="block text-xs font-medium text-muted">Layout Name</label>
          <input
          ...
          <div className="mt-5">
            <div className="text-xs font-medium text-muted">Monitors</div>
        ...
        <div className="flex items-center justify-between px-6 py-4">
          <div className="text-xs text-muted">Esc to cancel • Ctrl/⌘+Enter to save</div>
